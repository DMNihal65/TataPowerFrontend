  ...
  return (
    <Layout className="min-h-screen" style={{ background: 'linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%)' }}>
      ...
      <Content className="p-4 sm:p-6 lg:p-8 mt-16 flex flex-col-reverse sm:flex-row">
        <Card className="sm:w-1/3 sm:mr-6 sm:mb-0 mb-6" style={{ borderRadius: '15px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
          <FilterControls />
        </Card>
        <Card className="flex-grow bg-white shadow-lg rounded-xl overflow-hidden" style={{ borderRadius: '15px' }}>
          <List
